<section class="newsletter-subscription stretch-full-width"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/26.jpg ); height: 460px;">
    <div class="caption">
        ...
        <form method="post" action="pages/subscribe" name="subscribe">
            <div class="newsletter-form">
                    @csrf

                <input type="email" name="email_sub" placeholder="Type here your email address to receive our newsletter" />
                       </div>
            <div class="newsletter-form">
                    @csrf

                <input class="button" type="submit">Subscribe</input>
                       </div>
